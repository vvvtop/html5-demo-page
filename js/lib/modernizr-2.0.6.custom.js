 ...
 * Contains: fontface | boxshadow | cssanimations | cssgradients | csstransforms | csstransitions | canvas | draganddrop | audio | video | inputtypes | localstorage | iepp | mq | cssclasses | teststyles | testprop | testallprops | hasevent | prefixes | domprefixes | load
 */
;
window.Modernizr = function (a, b, c) {
	...
	w = function () {
		function d(d, e) {
			...
			d = "on" + d;
			var f = d in e;
			f || (e.setAttribute || (e = b.createElement("div")), e.setAttribute && e.removeAttribute && (e.setAttribute(d, ""), f = C(e[d], "function"), C(e[d], c) || (e[d] = c), e.removeAttribute(d))),
			e = null;
			return f
		}
		var a = {
	...
	for (var I in q)
		z(q, I) && (x = I.toLowerCase(), e[x] = q[I](), t.push((e[x] ? "" : "no-") + x));
	e.input || H(),
	A(""),
	j = l = null,
